...
/* 
    Riscrivere la pagina delle FAQ di Google creando una "database" e stampandone il contenuto con PHP.
    https://policies.google.com/faq
*/


// creazione della struttura dati - - - - - ARRAY MULTIDIMENSIONALE

$faqs = [ // primo livello: array contenitore con indici numerici
    [ // secondi livelli: array associativi - PRIMA DOMANDA
    ...
    [ // TERZA DOMANDA
        ...
        "answer" => [
            "intro" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:",
            "numbers" => [
                "one" => "La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:",
                "two" => "La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali."
            ],
            "letters" => [
                "letterA" => "Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.",
                "letterB" => "Google LLC, con sede negli Stati Uniti, per il resto del mondo."
            ],
            "paragraph" => "Stabilire il paese associato al tuo account
